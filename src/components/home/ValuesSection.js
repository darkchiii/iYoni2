            ...
            <div className='values-rectangle'>
                ...
                <div className='values-row'>
                    ...
                    <div className='values-col-3'>
                        <p>Dane, z których korzystamy, zostały opracowane przez lekarzy, na<br/> co dzień pracujących z parami starającymi się o ciążę. Bazują na<br/> aktualnej wiedzy, rekomendacjach polskich i<br/> międzynarodowych towarzystw medycznych i wynikach badań naukowych.</p>
                    </div>
                </div>
...
<hr className='values-hr'/>
                ...
                <div className='values-row'>
                    ...
                    <div className='values-col-3'>
                        <p>Zdajemy sobie sprawę, że Twój profil w iYoni może zawierać wrażliwe informacje nt. Twojego zdrowia i płodności. Dlatego dokładamy wszelkich starań, byś miała pewność, że Twoje dane są bezpieczne. Działamy zgodnie z przepisami prawa polskiego i dyrektyw Unii Europejskiej w zakresie ochrony danych.</p>
                    </div>
                </div>
